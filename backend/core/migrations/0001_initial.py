    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visa_requirements', models.TextField(verbose_name='Visa Requirements')),
                ('processing_time', models.IntegerField(verbose_name='Processing Time (days)')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('passport_number', models.CharField(max_length=20, unique=True, verbose_name='Passport Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purpose_of_travel', models.TextField(verbose_name='Purpose of Travel')),
                ...
                ('number_of_applicants', models.IntegerField(default=1, verbose_name='Number of Applicants')),
                ...
                ('documents', models.JSONField(verbose_name='Uploaded Documents')),
